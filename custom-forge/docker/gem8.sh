...
EOF
cp $origin/appinfo/app.svg img/app.svg

# --- File: lib/AppInfo/Application.php ---
cp $origin/files/Application.php lib/AppInfo/Application.php

# --- File: lib/Controller/PageController.php ---
cp $origin/files/PageController.php lib/Controller/PageController.php

# --- File: lib/Controller/ErosController.php ---
cp $origin/files/ErosController.php lib/Controller/ErosController.php

# --- File: templates/main.php ---
cp $origin/files/main.php templates/main.php
